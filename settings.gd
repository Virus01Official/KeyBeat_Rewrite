...
func save_settings() -> void:
	...
	config.set_value("audio", "master_volume", $Panel/Control2/VBoxContainer/Control2/Label/HSlider.value)
	config.set_value("audio", "sfx_volume", $Panel/Control2/VBoxContainer/Control3/Label/SFX_Slider.value)
...
func load_settings() -> void:
	...
	$Panel/Control2/VBoxContainer/Control2/Label/HSlider.value = master_vol
	$Panel/Control2/VBoxContainer/Control3/Label/SFX_Slider.value = sfx_vol
	...
	$Panel/Control3/VBoxContainer/Control3/Label/scroll_vel.value = scroll_speed
	$Panel/Control3/VBoxContainer/Control3/Label/LineEdit.text = str(scroll_speed)
	
	var show_fps = config.get_value("display", "show_fps", false)
	$"../Label".visible = show_fps
	$Panel/Control/VBoxContainer/Control3/Label/CheckBox.button_pressed = show_fps
	
	var vsync = config.get_value("display", "vsync", true)
	$Panel/Control/VBoxContainer/Control2/Label/CheckBox.button_pressed = vsync
	if vsync:
...
func _on_scroll_vel_value_changed(valuer: float) -> void:
	...
	if not $Panel/Control3/VBoxContainer/Control3/Label/LineEdit.is_editing():
		$Panel/Control3/VBoxContainer/Control3/Label/LineEdit.text = str(valuer)

func _on_line_edit_text_changed(new_text: String) -> void:
	$Panel/Control3/VBoxContainer/Control3/Label/scroll_vel.value = int(new_text)
